...
type FlatConfig struct {
	...
	ConfigurationParams      map[string]string `mapstructure:"configuration_params" cty:"configuration_params" hcl:"configuration_params"`
	MofPath                  *string           `mapstructure:"mof_path" cty:"mof_path" hcl:"mof_path"`
	ConfigurationFilePath    *string           `mapstructure:"configuration_file" cty:"configuration_file" hcl:"configuration_file"`
	...
	ConfigurationName        *string           `mapstructure:"configuration_name" cty:"configuration_name" hcl:"configuration_name"`
	ModulePaths              []string          `mapstructure:"module_paths" cty:"module_paths" hcl:"module_paths"`
	ResourcePaths            []string          `mapstructure:"resource_paths" cty:"resource_paths" hcl:"resource_paths"`
	InstallPackageManagement *bool             `mapstructure:"install_package_management" cty:"install_package_management" hcl:"install_package_management"`
	InstallModules           map[string]string `mapstructure:"install_modules" cty:"install_modules" hcl:"install_modules"`
	StagingDir               *string           `mapstructure:"staging_dir" cty:"staging_dir" hcl:"staging_dir"`
	CleanStagingDir          *bool             `mapstructure:"clean_staging_dir" cty:"clean_staging_dir" hcl:"clean_staging_dir"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"configuration_params":       &hcldec.AttrSpec{Name: "configuration_params", Type: cty.Map(cty.String), Required: false},
		...
		"install_modules":            &hcldec.AttrSpec{Name: "install_modules", Type: cty.Map(cty.String), Required: false},
